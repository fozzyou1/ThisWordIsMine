...
var facialMatName             : String = "f05_face_00";

private var guiShowFlg           : boolean = false;
private var viewerResourcesPath  : String = "Satomi";
...
function Start () {
	...
	viewCam = GameObject.Find("Main Camera").GetComponent("satomi_viewscript");
